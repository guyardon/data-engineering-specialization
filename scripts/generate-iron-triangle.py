...
def line(id, x, y, pts, stroke, sw=2, op=100):
    els.append({"type":"line","id":id,"x":x,"y":y,
        "width":max(abs(p[0]) for p in pts),"height":max(abs(p[1]) for p in pts),"angle":0,
        "points":pts,"startArrowhead":None,"endArrowhead":None,
...
def diamond(id, x, y, w, h, stroke, bg, fill="solid", opacity=100, bnd=None):
    els.append({"type":"diamond","id":id,"x":x,"y":y,"width":w,"height":h,"angle":0,
        "strokeColor":stroke,"backgroundColor":bg,"fillStyle":fill,"strokeWidth":2,
        "strokeStyle":"solid","roughness":1,"opacity":opacity,
        "roundness":{"type":2},"seed":ns(),"version":1,"versionNonce":ns(),
        "isDeleted":False,"groupIds":[],"boundElements":bnd or [],
        "frameId":None,"link":None,"locked":False,"updated":1710000000000})
...
# Draw triangle edges
line("tri_left", top_x, top_y, [[0, 0], [left_x - top_x, left_y - top_y]], "#868e96", sw=2, op=60)
line("tri_right", top_x, top_y, [[0, 0], [right_x - top_x, right_y - top_y]], "#868e96", sw=2, op=60)
line("tri_bottom", left_x, left_y, [[0, 0], [right_x - left_x, 0]], "#868e96", sw=2, op=60)
...
vertices = [
    {
        ...
        "x": top_x - BOX_W // 2, "y": top_y - BOX_H - 10,
    },
    {
        "id": "budget", "title": "Budget",
        "subtitle": "Available resources",
        "stroke": "#2f9e44", "bg": "#b2f2bb",
        "x": left_x - BOX_W - 10, "y": left_y - BOX_H // 2,
    },
    {
        "id": "scope", "title": "Scope",
        "subtitle": "System features",
        "stroke": "#e67700", "bg": "#ffec99",
        "x": right_x + 10, "y": right_y - BOX_H // 2,
    },
]
...
for v in vertices:
    ...
    rect(vid, v["x"], v["y"], BOX_W, BOX_H,
         v["stroke"], v["bg"], fill="solid", bnd=bnd)
    ...
    txt(title_id, v["x"], title_y, BOX_W, title_h,
        v["title"], FONT_TITLE, color="#1e1e1e", cid=vid)
    txt(sub_id, v["x"], sub_y, BOX_W, sub_h,
        v["subtitle"], FONT_SUB, color=v["stroke"], valign="top")
...
diamond("center", center_x - DIAMOND_W // 2, center_y - DIAMOND_H // 2,
        DIAMOND_W, DIAMOND_H, "#c92a2a", "#ffc9c9", fill="solid",
        bnd=[{"type": "text", "id": "center_txt"}])

center_txt_h = th("Pick Two", 22)
txt("center_txt", center_x - DIAMOND_W // 2, center_y - center_txt_h // 2,
    DIAMOND_W, center_txt_h, "Pick Two", 22, color="#1e1e1e", cid="center")
...
txt("note", PAD_X, note_y, CONTENT_W, note_h,
    note_text, 18, color="#868e96")
