...
def gen(dark: bool):
    ...
    if dark:
        cc = {
            ...
            "consumers": {"bg": "#1a2a2a", "fc": "#67e8f9", "border": "#0c8599"},
        ...
        cc = {
            ...
            "consumers": {"bg": "#99e9f240", "fc": "#0c8599", "border": "#0c8599"},
    ...
    out_path = os.path.join(OUT_DIR, f"kinesis-data-streams-aws{suffix}")
    ...
    with Diagram(
        ...
        with Cluster("Consumers", graph_attr=cattr("consumers")):
            lam = Lambda("Lambda")
            glue = Glue("Glue")
