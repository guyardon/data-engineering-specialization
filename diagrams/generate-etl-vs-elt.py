...
# Data Sources
rect("etl_ds", COL1_X, ROW1_Y, BW, BH, *GRAY, bnd=[{"id": "etl_ds_t", "type": "text"}])
...
# Data Sources
rect("elt_ds", COL2_X, ROW1_Y, BW, BH, *GRAY, bnd=[{"id": "elt_ds_t", "type": "text"}])
...
# Data Warehouse (Load)
rect("elt_wh", COL2_X, ROW2_Y, BW, BH, *BLUE, bnd=[{"id": "elt_wh_t", "type": "text"}])
