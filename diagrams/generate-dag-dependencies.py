...
# Title
TITLE_Y = 15
txt("title", PAD_X, TITLE_Y, CANVAS_W - 2 * PAD_X, 40, "DAG Dependency Patterns", 32)
txt(
    "sub",
    PAD_X,
    TITLE_Y + 38,
...
rect("p1_b1", P1_B1_X, P1_BOX_Y, BW, BH, *BLUE, bnd=[{"id": "p1_t1", "type": "text"}])
txt("p1_t1", P1_B1_X, P1_BOX_Y, BW, BH, "task1", 18, cid="p1_b1")

rect("p1_b2", P1_B2_X, P1_BOX_Y, BW, BH, *BLUE, bnd=[{"id": "p1_t2", "type": "text"}])
txt("p1_t2", P1_B2_X, P1_BOX_Y, BW, BH, "task2", 18, cid="p1_b2")

rect("p1_b3", P1_B3_X, P1_BOX_Y, BW, BH, *BLUE, bnd=[{"id": "p1_t3", "type": "text"}])
...
rect("p2_b1", P2_B1_X, P2_BOX_Y, BW, BH, *GREEN, bnd=[{"id": "p2_t1", "type": "text"}])
txt("p2_t1", P2_B1_X, P2_BOX_Y, BW, BH, "task1", 18, cid="p2_b1")

rect(
    "p2_b2", P2_B2_X, P2_B2_Y_TOP, BW, BH, *GREEN, bnd=[{"id": "p2_t2", "type": "text"}]
)
txt("p2_t2", P2_B2_X, P2_B2_Y_TOP, BW, BH, "task2", 18, cid="p2_b2")

rect(
    "p2_b3", P2_B2_X, P2_B3_Y_BOT, BW, BH, *GREEN, bnd=[{"id": "p2_t3", "type": "text"}]
)
...
T0_X = COL2_X + 5
T0_Y = P4_BOX_Y + 30
rect("p4_t0", T0_X, T0_Y, BW_S, BH_S, *YELLOW, bnd=[{"id": "p4_t0t", "type": "text"}])
...
T1_Y = P4_BOX_Y + 5
T2_Y = T1_Y + BH_S + 20
rect("p4_t1", T12_X, T1_Y, BW_S, BH_S, *YELLOW, bnd=[{"id": "p4_t1t", "type": "text"}])
txt("p4_t1t", T12_X, T1_Y, BW_S, BH_S, "t1", 16, cid="p4_t1")

rect("p4_t2", T12_X, T2_Y, BW_S, BH_S, *YELLOW, bnd=[{"id": "p4_t2t", "type": "text"}])
...
T3_Y = T1_Y
T4_Y = T2_Y
rect("p4_t3", T34_X, T3_Y, BW_S, BH_S, *YELLOW, bnd=[{"id": "p4_t3t", "type": "text"}])
txt("p4_t3t", T34_X, T3_Y, BW_S, BH_S, "t3", 16, cid="p4_t3")

rect("p4_t4", T34_X, T4_Y, BW_S, BH_S, *YELLOW, bnd=[{"id": "p4_t4t", "type": "text"}])
txt("p4_t4t", T34_X, T4_Y, BW_S, BH_S, "t4", 16, cid="p4_t4")

# t5 on the right
T5_X = T34_X + BW_S + COL_GAP
T5_Y = T0_Y
rect("p4_t5", T5_X, T5_Y, BW_S, BH_S, *YELLOW, bnd=[{"id": "p4_t5t", "type": "text"}])
