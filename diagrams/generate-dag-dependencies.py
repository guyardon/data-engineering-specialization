...
d.rect("p1_b1", P1_B1_X, P1_BOX_Y, BW, BH, *BLUE, fill="hachure", bnd=[{"id": "p1_t1", "type": "text"}])
d.txt("p1_t1", P1_B1_X, P1_BOX_Y, BW, BH, "task1", 18, cid="p1_b1")

d.rect("p1_b2", P1_B2_X, P1_BOX_Y, BW, BH, *BLUE, fill="hachure", bnd=[{"id": "p1_t2", "type": "text"}])
d.txt("p1_t2", P1_B2_X, P1_BOX_Y, BW, BH, "task2", 18, cid="p1_b2")

d.rect("p1_b3", P1_B3_X, P1_BOX_Y, BW, BH, *BLUE, fill="hachure", bnd=[{"id": "p1_t3", "type": "text"}])
...
d.rect("p2_b1", P2_B1_X, P2_BOX_Y, BW, BH, *GREEN, fill="hachure", bnd=[{"id": "p2_t1", "type": "text"}])
d.txt("p2_t1", P2_B1_X, P2_BOX_Y, BW, BH, "task1", 18, cid="p2_b1")

d.rect(
    "p2_b2", P2_B2_X, P2_B2_Y_TOP, BW, BH, *GREEN, fill="hachure", bnd=[{"id": "p2_t2", "type": "text"}]
)
d.txt("p2_t2", P2_B2_X, P2_B2_Y_TOP, BW, BH, "task2", 18, cid="p2_b2")

d.rect(
    "p2_b3", P2_B2_X, P2_B3_Y_BOT, BW, BH, *GREEN, fill="hachure", bnd=[{"id": "p2_t3", "type": "text"}]
)
...
T0_X = COL2_X + 5
T0_Y = P4_BOX_Y + 30
d.rect("p4_t0", T0_X, T0_Y, BW_S, BH_S, *YELLOW, fill="hachure", bnd=[{"id": "p4_t0t", "type": "text"}])
...
T1_Y = P4_BOX_Y + 5
T2_Y = T1_Y + BH_S + 20
d.rect("p4_t1", T12_X, T1_Y, BW_S, BH_S, *YELLOW, fill="hachure", bnd=[{"id": "p4_t1t", "type": "text"}])
d.txt("p4_t1t", T12_X, T1_Y, BW_S, BH_S, "t1", 16, cid="p4_t1")

d.rect("p4_t2", T12_X, T2_Y, BW_S, BH_S, *YELLOW, fill="hachure", bnd=[{"id": "p4_t2t", "type": "text"}])
...
T3_Y = T1_Y
T4_Y = T2_Y
d.rect("p4_t3", T34_X, T3_Y, BW_S, BH_S, *YELLOW, fill="hachure", bnd=[{"id": "p4_t3t", "type": "text"}])
d.txt("p4_t3t", T34_X, T3_Y, BW_S, BH_S, "t3", 16, cid="p4_t3")

d.rect("p4_t4", T34_X, T4_Y, BW_S, BH_S, *YELLOW, fill="hachure", bnd=[{"id": "p4_t4t", "type": "text"}])
d.txt("p4_t4t", T34_X, T4_Y, BW_S, BH_S, "t4", 16, cid="p4_t4")

# t5 on the right
T5_X = T34_X + BW_S + COL_GAP
T5_Y = T0_Y
d.rect("p4_t5", T5_X, T5_Y, BW_S, BH_S, *YELLOW, fill="hachure", bnd=[{"id": "p4_t5t", "type": "text"}])
