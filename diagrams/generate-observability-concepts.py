...
# Title
title_w = CONTENT_W
txt("title", PAD_X, TITLE_Y, title_w, TITLE_H,
    "Observability Concepts", 32, color="#1e1e1e")

# --- Left column: DevOps Observability ---
rect("devops-hdr", LEFT_X, HDR_Y, COL_W, HDR_H, *BLUE,
     bnd=[{"id": "devops-hdr-t", "type": "text"}])
txt("devops-hdr-t", LEFT_X, HDR_Y, COL_W, HDR_H,
    "DevOps Observability", 24, cid="devops-hdr")

rect("devops-desc", LEFT_X, DESC_Y, COL_W, DESC_H, BLUE[0], "transparent",
     dashed=True, bnd=[{"id": "devops-desc-t", "type": "text"}])
txt("devops-desc-t", LEFT_X, DESC_Y, COL_W, DESC_H,
    "Monitors system health:\nCPU, RAM, response time.\nDetects anomalies and\nprevents downtime.", 20, color=BLUE[0], cid="devops-desc")

rect("devops-metrics", LEFT_X, BULLET_Y, COL_W, BULLET_H, BLUE[0], "#dbe4ff",
     bnd=[{"id": "devops-metrics-t", "type": "text"}])
txt("devops-metrics-t", LEFT_X, BULLET_Y, COL_W, BULLET_H,
    "• CPU utilization\n• Memory usage\n• Response time\n• Error rates\n• Uptime / availability", 20, cid="devops-metrics")

# --- Right column: Data Observability ---
rect("data-hdr", RIGHT_X, HDR_Y, COL_W, HDR_H, *GREEN,
     bnd=[{"id": "data-hdr-t", "type": "text"}])
txt("data-hdr-t", RIGHT_X, HDR_Y, COL_W, HDR_H,
    "Data Observability", 24, cid="data-hdr")

rect("data-desc", RIGHT_X, DESC_Y, COL_W, DESC_H, GREEN[0], "transparent",
     dashed=True, bnd=[{"id": "data-desc-t", "type": "text"}])
txt("data-desc-t", RIGHT_X, DESC_Y, COL_W, DESC_H,
    "Monitors data health:\naccuracy, completeness,\ntimeliness. Mitigates\nupstream changes.", 20, color=GREEN[0], cid="data-desc")

rect("data-metrics", RIGHT_X, BULLET_Y, COL_W, BULLET_H, GREEN[0], "#d3f9d8",
     bnd=[{"id": "data-metrics-t", "type": "text"}])
txt("data-metrics-t", RIGHT_X, BULLET_Y, COL_W, BULLET_H,
    "• Is the data up-to-date?\n• Is the data complete?\n• Are fields in range?\n• Is null rate expected?\n• Has the schema changed?", 20, cid="data-metrics")

# Arrow from DevOps to Data (showing evolution)
arr("evolve", LEFT_X + COL_W, HDR_Y + HDR_H // 2,
    [[0, 0], [COL_GAP, 0]], GRAY[0],
