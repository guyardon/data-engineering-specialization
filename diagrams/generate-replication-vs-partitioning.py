...
SRC_Y = 85
d.rect("src", SRC_X, SRC_Y, SRC_W, SRC_H, *GRAY, fill="hachure", bnd=[{"id": "src_t", "type": "text"}])
...
d.rect("rep_c", LEFT_X, SECTION_Y + 20, COL_W, CONTAINER_H, *GREEN, fill="hachure", dashed=True)
...
# Container
d.rect("part_c", RIGHT_X, SECTION_Y + 20, COL_W, CONTAINER_H, *PURPLE, fill="hachure", dashed=True)
