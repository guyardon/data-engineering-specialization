...
T1_X = PAD_X + 20
T1_Y = ROW1_Y + 30
d.rect("task1", T1_X, T1_Y, BW_TASK, BH, *BLUE, fill="hachure", bnd=[{"id": "t_task1", "type": "text"}])
...
d.rect("db", DB_X, DB_Y, DB_W, DB_H, *GRAY, fill="hachure", bnd=[{"id": "t_db", "type": "text"}])
...
T2_Y = DB_Y
d.rect("task2", T2_X, T2_Y, BW_TASK, BH, *GREEN, fill="hachure", bnd=[{"id": "t_task2", "type": "text"}])
