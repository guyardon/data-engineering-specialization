...
d.txt(
    ...
    BOX_W,
    45,
    "Events may arrive out of order\nor delayed by seconds to hours",
    17,
    color=BLUE[0],
)
...
d.txt(
    ...
    BOX_W,
    65,
    "Tracks the expected progress of event time\n— declares when a window is 'complete'",
    17,
    color=GREEN[0],
)
...
# === WRITE ===
name = sys.argv[1] if len(sys.argv) > 1 else "diagrams/artifacts/watermarks"
