...
d.txt(
    ...
    CONTENT_W,
    TITLE_H,
    "Keeping Storage Systems In Sync",
    TITLE_FSZ,
)
...
# Description box
d.rect(
    "desc1", COL1_X + DESC_OFF, DESC_Y, DESC_W, DESC_H, *RED, opacity=40, dashed=True
)
d.txt(
    "desc1-t",
    COL1_X + DESC_OFF,
...
# Description box
d.rect(
    "desc2", COL2_X + DESC_OFF, DESC_Y, DESC_W, DESC_H, *GREEN, opacity=40, dashed=True
)
d.txt(
    "desc2-t",
    COL2_X + DESC_OFF,
...
# === WRITE ===
name = sys.argv[1] if len(sys.argv) > 1 else "diagrams/artifacts/cdc-sync-methods"
