...
cards = [
    {
        "id": 1,
        "title": "1. Choose Common\nComponents Wisely",
        "subtitle": "Tools that benefit all teams",
        "stroke": "#1971c2",
        "bg": "#a5d8ff",
        "h": 90,
    },
    {
        "id": 2,
        "title": "2. Always Be Architecting",
        "subtitle": "Reversible decisions,\nloosely coupled systems",
        "stroke": "#2f9e44",
        "bg": "#b2f2bb",
        "h": 90,
    },
    ...
    {
        "id": 5,
        "title": "5. Embrace FinOps",
        "subtitle": "Cloud spending as\nengineering concern",
        "stroke": "#e67700",
        "bg": "#ffec99",
        "h": 90,
    },
...
for c in cards:
    ...
    d.rect(card_id, START_X, cur_y, CARD_W, h, c["stroke"], c["bg"], bnd=bnd)
    ...
    if c.get("pills"):
        ...
        for j, label in enumerate(pills):
            ...
            d.txt(
                pill_txt_id, px, ptxt_y, PILL_W, ptxt_h, label, FONT_PILL, cid=pill_id
            )
...
out_path = "diagrams/artifacts/architecture-principles-w3.excalidraw"
d.save(out_path)
