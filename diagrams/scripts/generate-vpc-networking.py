...
d.arr(
    ...
    [
        [0, 0],
        [0, ec2_1_y - ALB_Y - ALB_H + PILL_H // 2],
        [
            ec2_1_x + PILL_W // 2 - ALB_X - ALB_W // 4,
            ec2_1_y - ALB_Y - ALB_H + PILL_H // 2,
        ],
    ],
    PURPLE[0],
)
...
d.arr(
    ...
    [
        ...
        [0, ec2_1_y - ALB_Y - ALB_H + PILL_H // 2],
        [
            ec2_2_x + PILL_W // 2 - ALB_X - 3 * ALB_W // 4,
            ec2_1_y - ALB_Y - ALB_H + PILL_H // 2,
        ],
    ],
    PURPLE[0],
...
name = sys.argv[1] if len(sys.argv) > 1 else "diagrams/artifacts/vpc-networking"
