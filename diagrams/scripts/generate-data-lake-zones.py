...
for i, (bid, label, color) in enumerate(sources):
    ...
    d.rect(
        bid, x, SRC_Y, SRC_W, SRC_H, *color, bnd=[{"id": f"{bid}_t", "type": "text"}]
    )
...
d.rect("lake", PAD_X, LAKE_Y, CONTENT_W, LAKE_H, BLUE[0], "#dbe4ff", dashed=True)
...
# Title+subtitle box
d.rect(
    "z1", LAKE_INNER_X, Z1_Y, ZONE_W, ZONE_H, *RED, bnd=[{"id": "z1_t", "type": "text"}]
)
...
d.txt(
    "z1_t", LAKE_INNER_X, Z1_Y + z1_top_pad, ZONE_W, z1_title_h, z1_title, 24, cid="z1"
)
d.txt(
    "z1_sub",
    LAKE_INNER_X,
    Z1_Y + z1_top_pad + z1_title_h + z1_gap,
    ZONE_W,
    z1_sub_h,
    z1_sub,
    17,
...
d.txt(
    "z2_t", LAKE_INNER_X, Z2_Y + z2_top_pad, ZONE_W, z2_title_h, z2_title, 24, cid="z2"
)
d.txt(
    "z2_sub",
    LAKE_INNER_X,
    Z2_Y + z2_top_pad + z2_title_h + z1_gap,
    ZONE_W,
    z2_sub_h,
    z2_sub,
    17,
...
d.txt(
    "z3_t", LAKE_INNER_X, Z3_Y + z3_top_pad, ZONE_W, z3_title_h, z3_title, 24, cid="z3"
)
d.txt(
    "z3_sub",
    LAKE_INNER_X,
    Z3_Y + z3_top_pad + z3_title_h + z1_gap,
    ZONE_W,
    z3_sub_h,
    z3_sub,
    17,
...
d.txt(
    ...
    CAT_W,
    CAT_H,
    "Data Catalog (Schema, Partitions, Lineage)",
    20,
    cid="catalog",
)
...
# === WRITE FILE ===
name = sys.argv[1] if len(sys.argv) > 1 else "diagrams/artifacts/data-lake-zones"
