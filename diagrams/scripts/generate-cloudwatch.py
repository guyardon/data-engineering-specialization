...
# Title
d.txt(
    "title", PAD_X, TITLE_Y, CONTENT_W, TITLE_H, "AWS CloudWatch", 32, color="#1e1e1e"
)
...
d.txt(
    "sys-hdr-t", COL1_X, COL_START_Y, COL_W, HDR_H, "System Metrics", 22, cid="sys-hdr"
)
...
# === WRITE FILE ===
name = sys.argv[1] if len(sys.argv) > 1 else "diagrams/artifacts/cloudwatch"
