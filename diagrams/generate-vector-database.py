...
# === Step 1: Input Data ===
S1_Y = 90
d.rect("input", BOX_X, S1_Y, BW, BH, *GRAY, fill="hachure", bnd=[{"id": "input_t", "type": "text"}])
d.txt("input_t", BOX_X, S1_Y, BW, BH, "Input Data\nText, images, audio", 18, cid="input")
...
d.rect("embed", BOX_X, S2_Y, BW, BH, *CYAN, fill="hachure", bnd=[{"id": "embed_t", "type": "text"}])
d.txt(
    "embed_t",
    BOX_X,
    S2_Y,
...
d.rect("result", BOX_X, S4_Y, BW, BH, *GREEN, fill="hachure", bnd=[{"id": "result_t", "type": "text"}])
d.txt(
    "result_t",
    BOX_X,
    S4_Y,
